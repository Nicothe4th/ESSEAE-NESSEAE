function [P,A,Ds,S,Yh,Ji]=HybridNEBEAE(Yo,N,parameters,Po)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% [P,A,D,S,Yh,Ji]=HybridNEBEAE(Y,N,parameters,Po)
%
% Estimation by Hybrid Nonlinear Extended Blind End-member and Abundance Extraction 
%  Method with a Multi-Linear Mixture Model 
%
...
if display==1
        disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
        disp('Hybrid NEBEAE with Multi-Linear Unmixing');
...
while (Jp-J)/Jp >= epsilon && iter < maxiter && oae==0 && NUMERROR==0
    ...
    if NUMERROR==0
        ...
        P=hybridEndmember(Y,Ym,Pp,Am,Dm,Nf,rho,parallel);
...
function P = hybridEndmember(Z,Y,Po,A,D,Nf,rho,parallel)
