function [P,A,S,Yh,Ji]=HybridEBEAE(Yo,N,parameters,Po)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% [P,A,S,Yh,V,Ji]=HybridEBEAE(Y,N,parameters,Po)
%
% Estimation by Hybrid Extended Blind End-member and Abundance Extraction (EBEAE)
...
while (Jp-J)/Jp >= epsilon && iter < maxiter && initcond~=0 && NUMERROR==0
    ...
    Pp=P;
    if NUMERROR==0
        P = hybridEndmember(Ym,Am,P,Nf,rho); 
    end
    Jp=J;
...
function Pn = hybridEndmember(Y,A,P,Nf,rho)


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
%  Pn = hybridEndmember(Y,A,P,Nf,rho)
%
