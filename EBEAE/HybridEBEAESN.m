function [P,A,S,Yh,V,Ji]=HybridEBEAESN(Yo,N,parameters,Po)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% [P,A,S,Yh,V,Ji]=HybridEBEAESN(Y,N,parameters,Po)
%
...
while iter <= maxiter && initcond~=0 && NUMERROR==0
