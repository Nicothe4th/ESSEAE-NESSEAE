...
%clear all; 
addpath('EBEAE');
sSNR=[40 35 30];                % Tested values of SNR (Gaussian Noise)   
pDensity=[0.005 0.0075 0.01];   % Tested values of SUD (Sparse Noise) 
    ...
    for j=1:Rep 
        ...
        for n=0:4
            ...
            elseif n>0 && n<4
                ...
                Pu=P0(:,rNs);
                tic;
                [P1,A1,D1,S1,Zh1,V1,J1]=NESSEAE(Z,N,paramvec,Pu);
                tesseae=toc;
...
% Add title and labels
title('(e) \it Computational time (s)','FontSize',11, 'FontWeight','normal');
%ylabel('');
